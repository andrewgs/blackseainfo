...
$route['admin/manager/class'] = "admin_interface/manager_class";
$route['admin/manager/class/valid-alias'] = "admin_interface/valid_class_alias";
$route['admin/manager/class/save'] = "admin_interface/save_class";
...
$route['admin/manager/unit/valid-alias'] = "admin_interface/valid_unit_alias";
...
$route['admin/:any/manager/view-unit/:any'] = "admin_interface/view_unit";
