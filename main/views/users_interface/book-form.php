<?= form_open($this->uri->uri_string(),array('id'=>'reserve-form','class'=>'content-form')); ?>
	...
	<?php endif; ?>
		...
		<input type="text" class="inpvalue" id="cust-email" name="email" value="<?=set_value('email');?>" maxlength="100" placeholder="Введите адрес E-mail" /><label>Телефон: <span class="" title="Поле не может быть пустым">*</span></label>
